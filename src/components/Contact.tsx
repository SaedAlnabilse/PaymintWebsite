...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-paymint-dark">
      <div className="container mx-auto px-8 lg:px-20 max-w-6xl">
        <div className="max-w-4xl mx-auto bg-paymint-surface rounded-none shadow-2xl shadow-black/50 overflow-hidden flex flex-col md:flex-row border border-white/10">
          <div className="p-12 md:w-1/2 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-paymint-green/80 mix-blend-multiply" />
          ...
          <div className="p-12 md:w-1/2 bg-paymint-surface">
            <form className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-white mb-2">Full Name</label>
                <input type="text" className="w-full px-4 py-3 rounded-none bg-black/20 border border-white/10 text-white focus:border-paymint-green focus:ring-2 focus:ring-paymint-green/20 outline-none transition-all placeholder-gray-600" placeholder="John Doe" />
              </div>
              <div>
                <label className="block text-sm font-medium text-white mb-2">Business Name</label>
                <input type="text" className="w-full px-4 py-3 rounded-none bg-black/20 border border-white/10 text-white focus:border-paymint-green focus:ring-2 focus:ring-paymint-green/20 outline-none transition-all placeholder-gray-600" placeholder="Your Store LLC" />
              </div>
              <div>
                <label className="block text-sm font-medium text-white mb-2">Email</label>
                <input type="email" className="w-full px-4 py-3 rounded-none bg-black/20 border border-white/10 text-white focus:border-paymint-green focus:ring-2 focus:ring-paymint-green/20 outline-none transition-all placeholder-gray-600" placeholder="john@company.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-white mb-2">Message</label>
                <textarea rows={4} className="w-full px-4 py-3 rounded-none bg-black/20 border border-white/10 text-white focus:border-paymint-green focus:ring-2 focus:ring-paymint-green/20 outline-none transition-all placeholder-gray-600" placeholder="Tell us about your needs..." />
              </div>
              <div className="flex items-start gap-3">
                ...
                />
                <label htmlFor="policy" className="text-sm text-gray-400 cursor-pointer">
      ...
      {activeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={() => setActiveModal(null)}>
          <div className="bg-paymint-surface border border-white/10 rounded-none max-w-2xl w-full max-h-[80vh] overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 overflow-y-auto max-h-[60vh] text-gray-300 space-y-4">
              {activeModal === 'privacy' ? (
                <>
                  <p className="text-sm text-gray-400">Last updated: December 11, 2025</p>
                  ...
                  <h4 className="text-lg font-semibold text-white">2. How We Use Your Information</h4>
                  ...
                  <h4 className="text-lg font-semibold text-white">3. Information Sharing</h4>
                  ...
                  <h4 className="text-lg font-semibold text-white">5. Contact Us</h4>
                ...
                <>
                  ...
                  <h4 className="text-lg font-semibold text-white">2. Description of Service</h4>
                  ...
                  <h4 className="text-lg font-semibold text-white">5. Limitation of Liability</h4>
                  ...
                  <h4 className="text-lg font-semibold text-white">6. Contact</h4>
