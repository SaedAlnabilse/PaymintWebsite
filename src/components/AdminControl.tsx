...
export const AdminControl = () => {
  return (
    <section id="admin" className="py-24 bg-paymint-dark overflow-hidden">
      <div className="container mx-auto px-8 lg:px-20 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-stretch gap-16 lg:gap-24">
          ...
          >
            <h2 className="text-5xl lg:text-6xl font-bold font-sans text-white mb-8 tracking-tight">Stay in Control</h2>

            {/* Logo Lockup */}
            <div className="flex items-center gap-4 mb-8">
              <img src={WhiteLogo} alt="PayMint Logo" className="h-12 w-auto object-contain" />
