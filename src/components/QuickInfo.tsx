  ...
  return (
    <>
      <div
        ...
        className="inline-flex items-center justify-center ms-1.5 shrink-0 align-middle cursor-help text-gray-400 dark:text-gray-500 hover:text-mintcom-green transition-colors group"
      >
        <Info size={14} />
      </div>
